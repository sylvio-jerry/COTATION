...
const LivraisonFilter = ({exportPdf,exportExcel,filterOption,filterData}) => {
  ...
  const handleChangeDateDebut = (date) => {
    ...
    setFilter({...filter,date_debut_livraison:date});
  };

  const handleChangeDateFin = (date) => {
    // setDate_fin_contrat(date);
    setFilter({...filter,date_fin_livraison:date});
  };
        ...
        <div style={filterDown}>
          <div style={filterItem}>
            <div style={{}}>
              <Box style={{width: "100%"}}>
                <FormControl style={formStyle}>
                    <DatePicker label="DATE DEBUT" defaultValue={filter.date_debut_livraison} getDate={handleChangeDateDebut}/>
              ...
              <Box >
                <FormControl style={formStyle}>
                  <DatePicker label="DATE FIN" defaultValue={filter.date_fin_livraison} getDate={handleChangeDateFin}/>
