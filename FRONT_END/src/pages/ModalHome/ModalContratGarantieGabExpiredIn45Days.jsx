...
const ModalContratGarantieGabExpiredIn45Days = ({openModal,closeModal,data})=> {
  ...
  return (
    <div>
      ...
      >
        <DialogTitle id="scroll-dialog-title"> <HeaderLabel title="CONTRAT DE GARANTIE GAB"/></DialogTitle>
          <DialogContent
          >
            <ThemeProvider theme={theme}>
              <div style={ficheContainer}>
                <div style={ficheItem}>
                  <Typography variant="div"><strong>Liste de contrats de garantie gab expiré dans 45 jour : </strong>{contrat?.length}</Typography>
                </div>
                <div style={ficheItem}>
                      ...
                      <table className={` ${classes.tableContent}`}>
                        <thead  className={` ${classes.tableHeader}`}>
                          <tr>
                            ...
                            <th className={` ${classes.tableContentThTd}`}>DATE INSTALLATION</th>
                        ...
                        <tbody>
                          { contrat.map((contrat, index)=>{
                            return <tr key={index}>
                                      ...
                                      <td className={` ${classes.tableContentThTd}`}>{contrat?.date_installation ? date_format(contrat?.date_installation) : "-"}</td>
...
export default ModalContratGarantieGabExpiredIn45Days;