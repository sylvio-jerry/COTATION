...
const AddVille = ({openModal,closeModal,refresh})=> {
    ...
    if(ville.nom_ville.trim() !== '' && ville.province !==null){
      if(error.nom_ville === null && error.province === null){
        try {
          ...
          const data_ = await axios.post(`${API_URL}/api/ville`,newVille)
          ...
          console.log("error while addVilleRequest:", response);
      ...
      >
        <DialogTitle id="scroll-dialog-title"> 
          <div className={` ${classes.headerRecap } `}>
              <Typography variant="div"><strong>NOUVEAU VILLE </strong></Typography>
          </div>
        </DialogTitle>
          <DialogContent
          >
