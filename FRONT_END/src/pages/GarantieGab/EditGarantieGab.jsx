...
const EditGarantieGab = () => {
  ...
  const resume_ = {
      ...
      num_facture : contrat_?.equipement?.livraison?.num_facture ? contrat_?.equipement?.livraison?.num_facture : "Non Facturé" ,
      date_facture : contrat_?.equipement?.livraison?.date_facture ? moment(new Date(contrat_?.equipement?.livraison?.date_facture),"DD/MM/YYYY").format('DD/MM/YYYY') : "Non Facturé",
